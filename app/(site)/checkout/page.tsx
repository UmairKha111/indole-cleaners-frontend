        ...
        <div className="bg-slate-900 p-8 rounded-2xl border border-white/10 shadow-xl">
          ...
          <div className="space-y-5">
            ...
            <textarea
              ...
              value={form.address}
              onChange={updateField}
              className="w-full p-3 rounded-lg bg-slate-800 text-white border border-white/10 focus:border-cyan-400 outline-none h-24"
            />
          ...
          <button
            onClick={placeOrder}
            className="w-full mt-8 py-3 bg-cyan-400 text-white font-bold rounded-full hover:bg-cyan-300 transition shadow-lg"
          >
            Place Order
          </button>
        </div>
